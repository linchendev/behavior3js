...
本文件记录 `behavior3go` 在完成 `5.3` 非破坏性优化后的基准基线，方便后续优化前后直接对照。
...
```text
BenchmarkBehaviorTreeTickSequence-12      918710      1151 ns/op      480 B/op      17 allocs/op
BenchmarkBlackboardSetGet-12            14967994      78.60 ns/op       7 B/op       0 allocs/op
BenchmarkBehaviorTreeLoad-12              141595      8315 ns/op     2729 B/op      58 allocs/op
BenchmarkBehaviorTreeDump-12             1208515      999.0 ns/op    1872 B/op      15 allocs/op
